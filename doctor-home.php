...
$role = $_SESSION['role'] ?? 'Specialist Doctor'; // Lấy role để hiển thị
...
<body class="bg-gray-50 text-gray-800 font-sans min-h-screen flex flex-col">
    ...
    <nav class="bg-brand text-white shadow-md sticky top-16 z-40">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-8 flex justify-between items-end">
            ...
            <div class="text-right">
                <div class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Today</div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-full">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-3 items-start">
                            <div class="w-2 h-2 mt-2 bg-gray-300 rounded-full flex-shrink-0"></div>
                            <div>
                                <p class="text-sm font-medium text-gray-800">System Maintenance Scheduled</p>
                                <p class="text-xs text-gray-400 mt-1">Tomorrow, 00:00 - 02:00</p>
                            </div>
                        </div>
                    </div>
                </div>
